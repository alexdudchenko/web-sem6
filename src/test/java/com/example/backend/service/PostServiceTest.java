...
import com.example.backend.repos.PostRepository;
import com.example.backend.repos.SubredditRepository;
...
class PostServiceTest {
    ...
    void shouldFindPostById() {
        ...
        PostResponse expectedPostResponse = new PostResponse(123L, "First Post", "Test",
                "Test User", "Test Subredit", 0, "1 Hour Ago");
    ...
    void shouldSavePosts() {
        ...
        Post post = new Post(123L, "First Post", "Test",
                null, Instant.now(), null);
        PostRequest postRequest = new PostRequest(null, "First Subreddit", "First Post", "Test");
